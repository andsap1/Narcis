        ...
        <div class="col-lg-12 offset-lg-1"style="padding-top: 20px; margin-left: -15px">
            <table id="cart" class="table table-hover table-condensed" >
                ...
                @foreach($allNaud as $asNaud)
                    ...
                    <td>{{ $asNaud->email }}</td>
                    <td>{{ $asNaud->level }}</td>
                    <td width="50"><a href="#"><button class="button" type="edit"><svg class="bi bi-pencil" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
