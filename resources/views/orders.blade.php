                ...
                <div class="col-lg-12 offset-lg-1" style="padding-top: 20px; margin-left: -15px">
                    <table class="table table-hover table-condensed" >
                        ...
                        <tr style="border-bottom: 0px">
                            ...
                            <th style="width:20%;border-bottom: 10px;">Krepšelio ID</th>
                            <th></th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        @foreach($allUz as $asUZ)
                            <tr>
                                ...
                                @foreach($states as $state)
                                    @if($state->id_Busena == $asUZ->busena)
                                      <td>{{ $state->pavadinimas }}</td>
                                    @endif
                                @endforeach
                                <td>{{ $asUZ->data }}</td>
                                <td>{{ $asUZ->fk_Naudotojasid }}</td>
                                <td>{{ $asUZ->fk_Krepselisid }}</td>
                                <td width="50"><a href="{{route('adminRoutes.orderedit', $asUZ->id_Uzsakymas)}}"><button class="button blue" type="edit"><svg class="bi bi-pencil" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M11.293 1.293a1 1 0 011.414 0l2 2a1 1 0 010 1.414l-9 9a1 1 0 01-.39.242l-3 1a1 1 0 01-1.266-1.265l1-3a1 1 0 01.242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z" clip-rule="evenodd"/>
                                                <path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 00.5.5H4v.5a.5.5 0 00.5.5H5v.5a.5.5 0 00.5.5H6v-1.5a.5.5 0 00-.5-.5H5v-.5a.5.5 0 00-.5-.5H3z" clip-rule="evenodd"/>
                                            </svg></button></a></td>
                                <td width="50"><a onclick="return confirm('Ar tikrai norite ištrinti?')"   href="{{route('adminRoutes.deleteOrder', $asUZ->id_Uzsakymas)}}"><button class="button red" type="delete"><svg class="bi bi-x-square-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
