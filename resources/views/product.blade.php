...
{{--                    <td width="50"><a onclick="return confirm('Ar tikrai norite pašalinti?')" href="{{route('adminRoutes.deleteProduct', $item->id_Preke)}}"><button class="button" type="delete"><svg class="bi bi-x-square-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">--}}
